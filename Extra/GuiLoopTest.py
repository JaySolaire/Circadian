...
#11-- DAYLIGHT
r11box = pygame.draw.rect(gameWindow, (51,255,100), (0, 400, 300, 39))
#12-- STARS
#r12box = pygame.draw.rect(gameWindow, (51,255,100), (0, 400, 300, 39))
...
while(gameActive):
	...
	for event in evList:
		...
		if green < 0:
			green = 0
		if daylight == 1:
			daylight = Circadian(rpi, bpi, gpi, stars)
